...
PRODUCT_START_GATE_SECTION = re.compile(r"^## (First product-start gate|Первый product-start gate|Первый стартовый гейт продукта|Гейт текущей истины)$", re.MULTILINE)
