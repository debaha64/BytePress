...
- включать retired placeholder domains.
...
Недопустимо:
- оставлять созданный продукт зависимым от `BytePress` tooling во время обычных проверок;
- materialize retired placeholder domains как integration contour;
