...
- generated `Pipeline/Workflows.md` описывает основной путь продукта, первый старт продукта, предметный проход, гейты, уровни проверок, журнальное закрытие и PR-маршрут через `gh`;
