...
Локальные commits лучше делить по смыслу, когда pass затрагивает несколько слоёв: отдельно основание/planning, документы, код или generated service files, проверки/evidence и журнальное закрытие. Это не вводит обязательный fixed commit count, но удерживает review и rollback по слоям вместо одного смешанного коммита.
