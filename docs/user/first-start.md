...
Для TAS 0.0.2 используйте New Product, а старый TAS 0.0.1 — как внешний reference corpus первого research. Это не перенос старой среды в Product root. [Правило выбора операции](README.md#как-выбрать) применимо и к другим историческим материалам.
