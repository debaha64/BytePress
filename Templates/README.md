...
- реестровые и журнальные шаблоны задают порядок записей от старых к новым;
- новая запись добавляется в конец соответствующего реестра или журнала;
- верхняя навигация допустима как краткий служебный блок и не должна дублировать полный список записей;
