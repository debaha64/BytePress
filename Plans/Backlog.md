...
## Индекс
- нет активного этапа; backlog `ROAD-000027` выведен в `Plans/Archive/Backlog/ROAD-000027.md`
...
`ROAD-000027` завершён и выведен в `Plans/Archive/Backlog/ROAD-000027.md`.
