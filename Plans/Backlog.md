...
## Индекс
- нет активного этапа; backlog `ROAD-000024` выведен в `Plans/Archive/Backlog/ROAD-000024.md`
...
`ROAD-000024` завершён и выведен в `Plans/Archive/Backlog/ROAD-000024.md`.
