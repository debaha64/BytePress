...
Связанные_backlog: BACK-000037

### Описание
Текущий этап: определить место `Discussion`, `Research` и `Requirements` в системе, добавить для них канонические шаблоны и затем подготовить переход к введению самих discovery-артефактов.
