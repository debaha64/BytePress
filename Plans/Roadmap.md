...
### Описание
Этап открыт одним широким проходом `PLAN-000076`. Scope включает карты доменов, терминологический слой, активные документы, создаваемые bootstrap-строки, плановый и журнальный контур. Архивные планы, старые журнальные записи, `Minesweeper`, branch gate, fresh product check, developed product check и bootstrap contract не меняются без прямой необходимости.
