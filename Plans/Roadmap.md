...
Горизонт `0.4.0` состоит из этапов `ROAD-000043` ... `ROAD-000049`. Детальные планы этапов фиксируются в `Plans/Backlog.md` и отдельных `PLAN-*`; Roadmap удерживает стратегическую последовательность, зависимости и результат.
...
Статус: В_работе
Связи: BACK-000108, BACK-000109, BACK-000110, PLAN-000097, PLAN-000098, CHG-000109, CHG-000110, QL-000104, QL-000105
Источник: Запрос владельца от 2026-05-21
Дата_создания: 2026-05-21
Дата_изменения: 2026-05-21
...
### Закрытие
`BACK-000108` закрыт в `PLAN-000097`, `BACK-000109` закрыт в `PLAN-000098`. Этап остаётся в работе до выполнения `BACK-000110`.
