...
### Текущее состояние
`BACK-000124` открыт в `PLAN-000112`: архив завершённых планов отделяется от архива этапов, создаётся release archive и фиксируется следующий шаг по zip-архивации без создания zip-файлов в текущем проходе.
