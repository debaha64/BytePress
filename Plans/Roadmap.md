...
Статус: В_работе
Связи: BACK-000108, BACK-000109, BACK-000110, PLAN-000097, CHG-000109, QL-000104
Источник: Запрос владельца от 2026-05-21
Дата_создания: 2026-05-21
Дата_изменения: 2026-05-21
...
### Закрытие
`BACK-000108` закрыт в `PLAN-000097`. Этап остаётся в работе до выполнения `BACK-000109` и `BACK-000110`.
