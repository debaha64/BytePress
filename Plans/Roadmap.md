...
Статус: В_работе
Связи: BACK-000116, BACK-000117, PLAN-000104, PLAN-000105, CHG-000116, QL-000111, TERM-000027
Источник: Запрос владельца от 2026-05-21
Дата_создания: 2026-05-21
...
### Текущее состояние
`BACK-000116` закрыт в `PLAN-000104`: базовый протокол управляемого прохода закреплён в `Pipeline/Workflows.md`, `Rules/Workflow.md`, плановом контуре и терминологическом слое. `BACK-000117` выполняется в `PLAN-000105`: закрепляются смысловые шаги, локальные фиксации и возобновляемость прохода. `ROAD-000045` остаётся `В_работе`, потому что следующие задачи этапа ещё не завершены.
