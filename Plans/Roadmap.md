...
Статус: В_работе
Связи: BACK-000032, CHG-000034
Источник: PLAN-000022
...
Связанные_backlog: BACK-000032

### Описание
Этап фокусируется на полном каноне `Pipeline`, непрерывном дальнем пути `Roadmap` и производном `Backlog`, который строго следует этапам roadmap.
...
Статус: Черновик
Связи: отсутствуют
Источник: Следующий этап после governance-layer
Дата_создания: 2026-03-31
Дата_изменения: 2026-03-31
...
### Описание
Ближний следующий этап: определить место `Discussion`, `Research` и `Requirements` в системе, затем закрепить их переходы к `Roadmap`.
