...
Статус: Завершено
Связи: BACK-000119, BACK-000120, BACK-000121, BACK-000122, PLAN-000107, PLAN-000108, PLAN-000109, PLAN-000110, CHG-000119, CHG-000120, CHG-000121, CHG-000122, QL-000114, QL-000115, QL-000116, QL-000117
Источник: Запрос владельца от 2026-05-21
Дата_создания: 2026-05-21
Дата_изменения: 2026-05-23
Цель: Разделить уровни проверок и снизить хрупкость `Tools/bp_lint.py`.
Зависимости: ROAD-000045
Связанные_backlog: BACK-000119, BACK-000120, BACK-000121, BACK-000122
...
### Закрытие
`ROAD-000046` завершён после закрытия `BACK-000119`, `BACK-000120`, `BACK-000121` и `BACK-000122`. Проверочный контур разделяет `lint`, `check` и `verify`; `bp_lint.py` сохранён как быстрый structural check; минимальный `bp_check.py` материализует первый deterministic-состав уровня `check`; `bp_verify.py` оставлен будущим инструментом только после отдельного договора.
