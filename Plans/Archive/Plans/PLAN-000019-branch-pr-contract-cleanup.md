...
1. Зафиксировать управляемый контур прохода.
   ...
   - DoD: `Plans/Backlog.md` и `Plans/Archive/Plans/PLAN-000019-branch-pr-contract-cleanup.md` отражают фактическую задачу без расширения области.
...
## Артефакты
- `Plans/Backlog.md`
- `Plans/Archive/Plans/PLAN-000019-branch-pr-contract-cleanup.md`
- `AGENTS.md`
- `Setup_Guide.md`
