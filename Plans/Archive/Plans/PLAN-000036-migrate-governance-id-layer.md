...
- `Plans/Backlog.md`
- `Plans/Roadmap.md`
- `Plans/Archive/Plans/PLAN-000036-migrate-governance-id-layer.md`
- `Rules/*`
- `Standards/*`
- `Templates/*`
- `Schemas/*`
...
- `Plans/Archive/Plans/PLAN-000035-migrate-log-id-layer.md` выведен в archive, поэтому active `Plans/` на момент закрытия pass снова содержал только singleton files и текущий `PLAN-000036`, после чего и этот план стал частью archive-layer.
