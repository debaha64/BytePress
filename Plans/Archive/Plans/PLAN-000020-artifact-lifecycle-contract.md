...
1. Зафиксировать управляемый контур прохода.
   ...
   - DoD: `Plans/Backlog.md` и `Plans/Archive/Plans/PLAN-000020-artifact-lifecycle-contract.md` отражают scope без расширения области.
...
## Артефакты
- `Plans/Backlog.md`
- `Plans/Archive/Plans/PLAN-000020-artifact-lifecycle-contract.md`
