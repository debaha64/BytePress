...
1. Убрать orphan requirement reference из ранних plan-файлов.
   - DoD: `Plans/Archive/Plans/PLAN-000001-foundation.md` и `Plans/Archive/Plans/PLAN-000002-seed-docs-and-standards.md` больше не содержат orphan requirement reference, при этом смысл оснований и связей сохранён через существующие поля плана.
...
- `Plans/Archive/Plans/PLAN-000014-cleanup-orphan-ids.md`
- `Logs/ChangeLog.md`
- `Logs/QualityLog.md`
