...
## Zip-архивация
Исторические zip-пакеты созданы для выпусков `0.1.0`, `0.2.0`, `0.3.0` и `0.4.0` в корне release archive:
- `0.1.0.zip`;
- `0.2.0.zip`;
- `0.3.0.zip`;
- `0.4.0.zip`.
...
- `0.4.0.zip`: `ROAD-000043` ... `ROAD-000050`, `PLAN-000097` ... `PLAN-000122`.
...
После упаковки исторических интервалов открытые архивные каталоги хранят только post-release и будущий цикл после `0.4.0`: `Plans/Archive/Backlog/ROAD-000051.md` и далее, `Plans/Archive/Plans/PLAN-000123-*.md` и далее.
