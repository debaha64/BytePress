...
Активный `Backlog.md` хранит задачи только текущего этапа; если ни один этап не находится в `В_работе`, active backlog остаётся пустым и явно фиксирует отсутствие текущего этапа, а historical backlog прошлых этапов вынесен в `Plans/Archive/Backlog/`.
